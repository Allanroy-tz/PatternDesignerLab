...
{
    public class Tz202004407718_Brand03TVController : Tz202004407718_TVController
    {
        Tz202004407718_ICommand close, open, next, previous;

        public Tz202004407718_Brand03TVController(Tz202004407718_ICommand close, Tz202004407718_ICommand open, Tz202004407718_ICommand next, Tz202004407718_ICommand previous)
        {
            this.close = close;
            this.open = open;
            this.next = next;
